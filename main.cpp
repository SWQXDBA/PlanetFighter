...
int raw = 1000;
int column = 750;
int screan = 20;// raw/screan作为图片的大小
...
vector<IMAGE> bulletImages;//所有子弹的图标
vector<IMAGE> enemyEmages;//所有敌人的图标
vector<Bullet> bullets;//当前游戏中存在的所有子弹
vector<Enemy> enemys;//当前游戏中存在的所有敌人
EnemyFactory *enemyFactory;
int shootSpeed = 7;//玩家子弹发射速度 0-100 同时影响子弹飞行的速度
int enemyMoveSpeed = 2;//越大敌人移动得越快，同时影响敌人子弹飞行的速度
